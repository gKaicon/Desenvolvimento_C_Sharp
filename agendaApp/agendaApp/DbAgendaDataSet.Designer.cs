...
namespace agendaApp {
    ...
    public partial class DbAgendaDataSet : global::System.Data.DataSet {
        ...
        public partial class AgendaDataTable : global::System.Data.TypedTableBase<AgendaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AgendaRow AddAgendaRow(string nome, string cpf, string email, string telefone) {
        ...
        public partial class AgendaRow : global::System.Data.DataRow {
            ...
            public string cpf {
                get {
                    try {
                        return ((string)(this[this.tableAgenda.cpfColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("O valor da coluna \'cpf\' na tabela \'Agenda\' é DBNull.", e);
                    }
                }
                set {
                    this[this.tableAgenda.cpfColumn] = value;
                }
            }
            ...
            public string email {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("O valor da coluna \'email\' na tabela \'Agenda\' é DBNull.", e);
                    }
                }
                set {
            ...
            public string telefone {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("O valor da coluna \'telefone\' na tabela \'Agenda\' é DBNull.", e);
                    }
                }
                set {
            ...
            public bool IscpfNull() {
                return this.IsNull(this.tableAgenda.cpfColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetcpfNull() {
                this[this.tableAgenda.cpfColumn] = global::System.Convert.DBNull;
            }
...
namespace agendaApp.DbAgendaDataSetTableAdapters {
    ...
    public partial class AgendaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Agenda] WHERE (([id] = @Original_id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_cpf = 1 AND [cpf] IS NULL) OR ([cpf] = @Original_cpf)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_telefone = 1 AND [telefone] IS NULL) OR ([telefone] = @Original_telefone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Agenda] ([nome], [cpf], [email], [telefone]) VALUES (@nome, @c" +
                "pf, @email, @telefone);\r\nSELECT id, nome, cpf, email, telefone FROM Agenda WHERE" +
                " (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Agenda] SET [nome] = @nome, [cpf] = @cpf, [email] = @email, [telefone] = @telefone WHERE (([id] = @Original_id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_cpf = 1 AND [cpf] IS NULL) OR ([cpf] = @Original_cpf)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_telefone = 1 AND [telefone] IS NULL) OR ([telefone] = @Original_telefone)));
SELECT id, nome, cpf, email, telefone FROM Agenda WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::agendaApp.Properties.Settings.Default.DbAgendaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nome, cpf, email, telefone FROM dbo.Agenda";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM [dbo].[Agenda] WHERE ([id] = @Original_id) ";
            ...
            this._commandCollection[2].CommandText = "SELECT id, nome, cpf, email, telefone FROM dbo.Agenda WHERE NOME like @nome";
            ...
            this._commandCollection[3].CommandText = "INSERT INTO [dbo].[Agenda] ([nome], [cpf], [email], [telefone]) VALUES (@nome, @c" +
                "pf, @email, @telefone);";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@telefone", global::System.Data.SqlDbType.VarChar, 14, global::System.Data.ParameterDirection.Input, 0, 0, "telefone", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "UPDATE [dbo].[Agenda] SET [nome] = @nome, [cpf] = @cpf, [email] = @email, [telefo" +
                "ne] = @telefone WHERE [id] = @id;\r\nSELECT id, nome, cpf, email, telefone FROM Ag" +
                "enda WHERE (id = @id)";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@cpf", global::System.Data.SqlDbType.VarChar, 14, global::System.Data.ParameterDirection.Input, 0, 0, "cpf", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@telefone", global::System.Data.SqlDbType.VarChar, 14, global::System.Data.ParameterDirection.Input, 0, 0, "telefone", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Fill(DbAgendaDataSet.AgendaDataTable dataTable) {
        ...
        public virtual DbAgendaDataSet.AgendaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DbAgendaDataSet.AgendaDataTable dataTable = new DbAgendaDataSet.AgendaDataTable();
        ...
        public virtual int FillByNome(DbAgendaDataSet.AgendaDataTable dataTable, string nome) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DbAgendaDataSet.AgendaDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nome, string Original_cpf, string Original_email, string Original_telefone) {
        ...
        public virtual int Insert(string nome, string cpf, string email, string telefone) {
            if ((nome == null)) {
        ...
        public virtual int Update(string nome, string cpf, string email, string telefone, int Original_id, string Original_nome, string Original_cpf, string Original_email, string Original_telefone, int id) {
            if ((nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string cpf, string email, string telefone, int Original_id, string Original_nome, string Original_cpf, string Original_email, string Original_telefone) {
            return this.Update(nome, cpf, email, telefone, Original_id, Original_nome, Original_cpf, Original_email, Original_telefone, Original_id);
        }
        ...
        public virtual int InsertQuery(string nome, string cpf, string email, string telefone) {
        ...
        public virtual int UpdateQuery(string nome, string cpf, string email, string telefone, int id) {
